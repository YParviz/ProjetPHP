...
class Argument
{
    ...
    public function setIdCamp(int $idCamp): void
    {
        $this->idCamp = $idCamp;
    }

    public function getIdArgPrincipal(): ?int
    {
        return $this->idArgPrincipal;
    }
    public function setIdArgPrincipal(?int $idArgPrincipal): void
    {
        $this->idArgPrincipal = $idArgPrincipal;
    }
    ...
    public function getSousArguments(): array
    {
        return $this->sousArguments;
    }

    public function setSousArguments(array $sousArguments): void
    {
        $this->sousArguments = $sousArguments;
    }
